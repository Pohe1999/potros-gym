      ...
      <div className="container-max flex items-center justify-between py-4">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-200">Sistema de gestión</p>
          </div>
        </div>
        <div className="flex gap-6">
          ...
          <div className="text-center">
            ...
            <div className="text-xs text-gray-200">Activos</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-yellow-400">{members.length - activeCount}</div>
            <div className="text-xs text-gray-200">Inactivos</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-400">{totalVisitsToday}</div>
            <div className="text-xs text-gray-200">Visitas Hoy</div>
          </div>
        </div>
      </div>
    </header>
