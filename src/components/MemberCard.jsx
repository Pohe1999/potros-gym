...
export default function MemberCard({ member, onChange }) {
  ...
  return (
    <>
      <div className="bg-gray-900 p-5 rounded-lg card-shadow border-2 border-gray-800 hover:border-gray-700 transition-all">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 gap-3 bg-gray-800 p-3 rounded">
              <div>
